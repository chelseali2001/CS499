...
if True:
    ...
    input_dir = "../data/"
    output_dir = "../data/"
    bin_dir = os.path.join("C:\\Users\\chels\\CS499\\texture-master\\build\\bin", "Release");

    input_file_base_name = "207"
    ...
    input_file_name = os.path.join(input_dir, input_file_base_name + ".png") 
